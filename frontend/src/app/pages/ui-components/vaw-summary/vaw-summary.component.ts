...
@Component({
	selector: 'app-vaw-summary',
	templateUrl: './vaw-summary.component.html',
	styleUrls: ['./vaw-summary.component.scss'],
})
export class VawSummaryComponent implements OnInit {
	...
	exportToExcel(): void {
		...
		XLSX.writeFile(wb, 'VAW Summary.xlsx');
	}
